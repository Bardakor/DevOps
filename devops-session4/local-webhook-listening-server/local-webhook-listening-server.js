...
const repoDir = '/Users/liam/Documents/Efrei/ING1/S8/DevOps'; // this is where the code will pull your directory code locally just to use the docker-compose.yml file
const repoUrl = 'https://github.com/Bardakor/DevOps.git'; // this is the url of the repo you want to pull the code from
